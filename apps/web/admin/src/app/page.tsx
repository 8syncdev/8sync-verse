...
import { ArrowRight, LayoutDashboard, Settings, TrendingUp, Users } from "lucide-react";
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={label}
              className="rounded-verse-lg border border-verse-border bg-verse-surface p-4 flex items-center gap-4"
            >
