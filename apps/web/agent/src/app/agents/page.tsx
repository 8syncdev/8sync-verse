...
import { Bot, Brain, Code2, Sparkles, Zap } from "lucide-react";
...
export default function AgentsPage() {
  return (
    <DashboardLayout
      ...
      header={<span className="font-semibold text-sm">Agent Marketplace</span>}
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {AGENTS.map((agent) => {
            ...
            return (
              <div
                key={agent.id}
                className="rounded-verse-xl border border-border bg-card p-5 flex flex-col gap-3 hover:border-verse-primary/40 transition-colors"
              >
